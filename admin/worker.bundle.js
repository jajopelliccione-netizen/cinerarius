/* ============================================================
   Cinerarius Admin — BUNDLE in file unico (UI + API + render).
   Generato automaticamente da src/index.js + src/render.js.
   Incollalo nell'editor del Worker su Cloudflare (un solo file).
   ============================================================ */
